# Contributing to Redirects

Welcome! Our community focuses on helping others and making Redirects the best it
...
If unique, [open an issue](https://github.com/dsielert/redirector/issues)
and answer the questions so we can understand and reproduce the problematic
behavior.

The burden is on you to convince us that it is actually a bug in Redirects. This
...
Please be kind, remember that Redirects comes at no cost to you, and you're
getting free help.
...
resolving issues as you are able to. Thanks for making Redirects amazing!
...
Thanks for your help! Redirects would not be what it is today without your
contributions.
